...
En esta lección, analizarás y refinarás iterativamente tus prompts para generar copias de marketing a partir de una hoja de datos del producto.
...
- Limita el número de palabras/oraciones/caracteres.
...
- Pídele que se enfoque en los aspectos relevantes para la audiencia objetivo.
